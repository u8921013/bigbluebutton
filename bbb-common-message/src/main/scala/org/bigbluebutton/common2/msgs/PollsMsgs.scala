...
case class PollStartedEvtMsgBody(userId: String, pollId: String, pollType: String, secretPoll: Boolean, choiceNum: Int, question: String, poll: SimplePollOutVO)
...
case class StartCustomPollReqMsgBody(requesterId: String, pollId: String, pollType: String, secretPoll: Boolean, choiceNum: Int, answers: Seq[String], question: String)
...
case class StartPollReqMsgBody(requesterId: String, pollId: String, pollType: String, secretPoll: Boolean, choiceNum: Int, question: String)
